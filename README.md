## FlexNeuART
FlexNeuART (Flexible classical and NeurAl Retrieval Toolkit) is a substantially reworked `knn4qa` package. FlexNeuART is under active development. Detail description and documentaion is to appear. Description of the `knn4qa` is given below.
