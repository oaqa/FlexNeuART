...
class BiEncoderSBERT(BaseModel):
    ...
    def __init__(self, model_name):
        super().__init__()
        setattr(self, INNER_MODEL_ATTR, SentenceTransformer(model_name))
    ...
    def encode(self, encoded_text : Dict):
        """Generate sentence embeddings from text that is previously encoded by a tokenizer.

            :param encoded_text: a dictionary generated by the tokenizer
            :return an embedding tensor
        """
        model = getattr(self, INNER_MODEL_ATTR)
