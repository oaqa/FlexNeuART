...
class BartDecoder(BartPreTrainedModel):
    ...
    def forward(
        ...
        # Pytorch implemetation of Bart assumes the decoder would
        # always be use in a causal manner which is not in this case
        # We don't need to mask out the future tokens so we only just expand the attention mask
