...
print(f'Collection: {colName} # of epochs: {epochQty} model prefix: {modelFilePrefix}')
...
if True:
  ...
  with open(dataPrepFile, 'wb') as of:
    pickle.dump(prep, of) 
  ...
  model.fit(xTrain, yTrain, batch_size=128, epochs=3)
