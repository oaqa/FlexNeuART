...
PARAMS=( \
"napp_numPivot=8000,numPivotIndex=300,$PIVOT_FILE_PARAM" "numPivotSearch=18" \
"napp_numPivot=8000,numPivotIndex=300,$PIVOT_FILE_PARAM" "numPivotSearch=22" \
...
"napp_numPivot=8000,numPivotIndex=200,$PIVOT_FILE_PARAM" "numPivotSearch=15" \
"napp_numPivot=8000,numPivotIndex=200,$PIVOT_FILE_PARAM" "numPivotSearch=19" \

"napp_numPivot=8000,numPivotIndex=150,$PIVOT_FILE_PARAM" "numPivotSearch=9" \
