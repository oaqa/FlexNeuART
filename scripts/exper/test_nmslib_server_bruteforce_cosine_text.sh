...
HEADER_NAME="header_cosine_text"


CAND_PROV_TYPE="nmslib"
CAND_QTY="500"
#NUM_RET_LIST="1,2,3,4,5,10,15,20,25,30,35,45,50,60,70,80,90,100,500,1000,5000,10000"
...
$NMSLIB_PATH_SERVER/query_server -s $NMSLIB_SPACE -i $NMSLIB_HEADER -p $NMSLIB_PORT -m $NMSLIB_METHOD &> $SERVER_LOG_NAME  &
...
EXPER_DIR_BASE="results/final/$collect/$QREL_TYPE/$TEST_PART/nmslib/brute_force/$HEADER_NAME"
