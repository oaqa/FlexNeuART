...
function start_server {
  ...
  echo "Using index: $NMSLIB_INDEX"

  if [ ! -f "$NMSLIB_INDEX" ] ; then
    echo "Warning: index file: $NMSLIB_INDEX doesn't exist!"
  fi
...
PARAMS=( \
  "numPivot=8000,numPivotIndex=200,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=11" \
  "numPivot=8000,numPivotIndex=200,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=13" \
  "numPivot=8000,numPivotIndex=200,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=15" \
  "numPivot=8000,numPivotIndex=200,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=15" \
  "numPivot=8000,numPivotIndex=200,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=19" \
  "numPivot=8000,numPivotIndex=100,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=7" \
  "numPivot=8000,numPivotIndex=100,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=9" \
  "numPivot=8000,numPivotIndex=50,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=4" \
  "numPivot=8000,numPivotIndex=50,pivotFile=nmslib/squad/pivots/pivots_2field_maxTermQty50K_pivotTermQty1000" "numPivotSearch=5" \
)
