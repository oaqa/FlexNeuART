...
NUM_PIVOT=8000
HEADER_FILE_BASE="header_bm25_text"
HEADER_FILE_ALTERN="header_bm25_text_cosine"
...
#for numPivotIndex in 200 210 220 222 224 226 228 230 232 234 236 238 240 242 244 246 248 250 252 254
...
do
  ...
  # The commented-out settings are not-so-bad settings for COMPR
  #if [ $numPivotIndex -lt 300 ] ; then
  #  NUM_PIVOT_SEARCH=" -t numPivotSearch=8 -t numPivotSearch=9  -t numPivotSearch=10  -t numPivotSearch=11  -t numPivotSearch=12  -t numPivotSearch=13 -t numPivotSearch=14  -t numPivotSearch=15  -t numPivotSearch=16 -t numPivotSearch=17 -t numPivotSearch=18 -t numPivotSearch=19 -t numPivotSearch=20"
  #else
  #  NUM_PIVOT_SEARCH="    -t numPivotSearch=16 -t numPivotSearch=17 -t numPivotSearch=18 -t numPivotSearch=19 -t numPivotSearch=20 -t numPivotSearch=21 -t numPivotSearch=22 -t numPivotSearch=25 -t numPivotSearch=26 -t numPivotSearch=27 -t numPivotSearch=28 -t numPivotSearch=29"
  #fi 
