 ...
 * 
 * It is generated from a somewhat older variant of this NMSLIB file: 
 * https://github.com/nmslib/nmslib/blob/master/query_server/protocol.thrift
 * 
 * It should be still compatible and the only differences are:
 * 1. We changed Java package name similarity -> nmslib.
 * 2. There is no code to process batch query in this file.
 *
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
 *  @generated
 */
package edu.cmu.lti.oaqa.nmslib;
